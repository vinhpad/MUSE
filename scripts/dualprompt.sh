...
NOTE="DualPrompt" # Short description of the experiment. (WARNING: logs/results with the same note will be overwritten!)
...
do
    ...
    --note $NOTE --eval_period $EVAL_PERIOD --n_worker 4 --rnd_NM $WANDB
done